Il codice che si scrive in una lambda expression richiama semplicemente un metodo che è già implementato, quindi, invece di passare/assegnare una lambda che 
